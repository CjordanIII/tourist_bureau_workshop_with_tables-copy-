...
window.onload = function () {
  ...
  initCategoriesDropdown(categoriesDropdown);
...
function buildTableRow(tableBody, activity) {
  let newRow = tableBody.insertRow();
  for (let property in activity) {
    let newTd = newRow.insertCell();
    newTd.innerText = activity[property];
  }
}

function initCategoriesDropdown(categoriesDropdown) {
